...
<div class="row mt-2">  
    <div class="col-md-4">
        <div class="card card-lightblue color-palette box_shadow">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="forms-sample " method="POST" enctype="multipart/form-data" action="{{route("asnaf.store")}}" >
            @csrf
              <div class="card-body">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Nama </label>
                  <div class="col-sm-10">                    
                    <input type="text" value="{{ old('asnaf') }}" name="asnaf" class="form-control @error('asnaf') is-invalid @enderror" id="exampleInputName1" placeholder="Nama Asnaf">        
